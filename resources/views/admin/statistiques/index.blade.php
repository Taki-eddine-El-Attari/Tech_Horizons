            ...
            <div class="statistiques-section">
                ...
                <div class="statistiques-section-content">
                    <div class="statistiques-section-item">
                        ...
                        <p class="statistiques-section-item-value">{{ $articles->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Articles publiés</h3>
                        <p class="statistiques-section-item-value">{{ $articles->where('statut_id', 3)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Articles en attente</h3>
                        <p class="statistiques-section-item-value">{{ $articles->where('statut_id', 2)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Articles refusés</h3>
                        <p class="statistiques-section-item-value">{{ $articles->where('statut_id', 1)->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="statistiques-section">
                ...
                <div class="statistiques-section-content">
                    <div class="statistiques-section-item">
                        ...
                        <p class="statistiques-section-item-value">{{ $articles->where('theme_id', 1)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Nombre d'articles pour L'internet des objets</h3>
                        <p class="statistiques-section-item-value">{{ $articles->where('theme_id', 2)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Nombre d'articles pour Cybersécurité</h3>
                        <p class="statistiques-section-item-value">{{ $articles->where('theme_id', 3)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
            ...
            <div class="statistiques-section">
                ...
                <div class="statistiques-section-content">
                    <div class="statistiques-section-item">
                        ...
                        <p class="statistiques-section-item-value">{{ $articles->where('numero_id', 1)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Articles de numéro 2</h3>
                        <p class="statistiques-section-item-value">{{ $articles->where('numero_id', 2)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                    ...
                    <div class="statistiques-section-item">
                        ...
                        <p class="statistiques-section-item-value">{{ $numeros->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="statistiques-section">
                ...
                <div class="statistiques-section-content">
                    <div class="statistiques-section-item">
                        ...
                        <p class="statistiques-section-item-value">{{ $users->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Nombre d'éditeurs</h3>
                        <p class="statistiques-section-item-value">{{ $users->where('role', 'Éditeur')->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Nombre de responsables</h3>
                        <p class="statistiques-section-item-value">{{ $users->where('role', 'Responsable')->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Nombre d'abonné</h3>
                        <p class="statistiques-section-item-value">{{ $users->where('role', 'Abonné')->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="statistiques-section">
                ...
                <div class="statistiques-section-content">
                    <div class="statistiques-section-item">
                        ...
                        <p class="statistiques-section-item-value">{{ $commentaires->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Commentaires notés 5 étoiles </h3>
                        <p class="statistiques-section-item-value">{{ $commentaires->where('note', 5)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Commentaires notés 4 étoiles </h3>
                        <p class="statistiques-section-item-value">{{ $commentaires->where('note', 4)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Commentaires notés 3 étoiles </h3>
                        <p class="statistiques-section-item-value">{{ $commentaires->where('note', 3)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Commentaires notés 2 étoiles </h3>
                        <p class="statistiques-section-item-value">{{ $commentaires->where('note', 2)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Commentaires notés 1 étoile </h3>
                        <p class="statistiques-section-item-value">{{ $commentaires->where('note', 1)->count() }}</p>
                    </div>
                    <div class="statistiques-section-item">
                        <h3 class="statistiques-section-item-title">Commentaires sans étoiles</h3>
                        <p class="statistiques-section-item-value">{{ $commentaires->where('note', 0)->count() }}</p>
                    </div>
