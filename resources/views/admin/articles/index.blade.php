<x-default-layout titre="Gestion des articles">
    <div class="admin-header">
        ...
        <button class="btn" onclick="window.location.href='{{ route('admin.articles.create') }}'">Créer un post</button>
    </div>
    @if (!auth()->user()->isAbonne())
        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a href="#" class="link-primary delete-post" data-form="delete-form-{{ $article->id }}">
                            Supprimer
                        </a>
                        <form id="delete-form-{{ $article->id }}" action="{{ route('admin.articles.destroy', ['article' => $article]) }}" method="POST" class="hidden">
                            @csrf
                            @method('DELETE')
                        </form>
                    </td>
